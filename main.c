...
int main(int argc, char *argv[])
{
	...
	printf("Finished test, timeSlotsSum==%d,sumMoves==%d\n",timeSlotsSum,sumMoves);
	/*
	 * Number of Runs is complete, simulation is finished, print avg #timeSlots,,avg #moves and number of numTests
	 */
	printf("\n------------------------------------------\n");
	printf("Done with simulation\n");
	printf("average number of Moves==%d\n",sumMoves);
